...
class Config:
    ...
    def __init__(self):
        ...
        self.DEMO_API_BASE_URL = self._get_env_with_default(
            "DEMO_API_BASE_URL", 
            "https://x8ki-letl-twmt.n7.xano.io/api:N1uLlTBt"
        )
        ...
        self.DEMO_API_LOG_LEVEL = self._get_env_with_default("DEMO_API_LOG_LEVEL", "INFO")
        ...
        self.DEMO_API_OUTPUT_FILE = self._get_env_with_default("DEMO_API_OUTPUT_FILE", "vm_users.json")
