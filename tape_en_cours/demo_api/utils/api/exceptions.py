...
class UserCreationError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur lors de la création d'utilisateur",
                 status_code: Optional[int] = None,
                 response_data: Optional[Dict[str, Any]] = None,
...
class UserLoginError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur lors de la connexion utilisateur",
                 status_code: Optional[int] = None,
                 response_data: Optional[Dict[str, Any]] = None,
                 email: Optional[str] = None):
        super().__init__(message, status_code, response_data)
...
class UserInfoError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur lors de la récupération des informations utilisateur",
                 status_code: Optional[int] = None,
                 response_data: Optional[Dict[str, Any]] = None,
...
class UsersFetchError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur lors de la récupération des utilisateurs",
                 status_code: Optional[int] = None,
                 response_data: Optional[Dict[str, Any]] = None,
...
class VMsFetchError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur lors de la récupération des VMs",
                 status_code: Optional[int] = None,
                 response_data: Optional[Dict[str, Any]] = None,
                 base_url: Optional[str] = None):
        super().__init__(message, status_code, response_data)
...
class VMCreationError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur lors de la création de VM",
                 status_code: Optional[int] = None,
                 response_data: Optional[Dict[str, Any]] = None,
...
class TokenError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur liée au token",
                 status_code: Optional[int] = None,
                 response_data: Optional[Dict[str, Any]] = None,
                 token_length: Optional[int] = None):
        super().__init__(message, status_code, response_data)
...
class CredentialsError(DemoAPIException):
    ...
    def __init__(self, message: str = "Erreur liée aux identifiants",
                 email: Optional[str] = None,
