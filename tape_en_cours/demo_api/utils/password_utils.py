...
def get_email_from_env(env_var="DEMO_API_EMAIL"):
    ...
    if email:
        ...
        logger.debug("Aucun email trouvé dans les variables d'environnement", env_var=env_var)
...
def get_credentials_from_env(env_email="DEMO_API_EMAIL", env_password="DEMO_API_PASSWORD"):
    """
    ...
    if email and password:
        logger.info("Identifiants récupérés depuis les variables d'environnement", email=email)
        return email, password
    else:
        logger.warning("Identifiants incomplets dans les variables d'environnement", 
                     email_found=bool(email), password_found=bool(password))
        return None


def get_credentials_from_input(env_email="DEMO_API_EMAIL", env_password="DEMO_API_PASSWORD"):
    """
...
def get_credentials(
    ...
    if email:
        ...
        logger.info("Identifiants récupérés avec succès", email=email, password_source="mixed")
        return email, password
    ...
    logger.warning("Identifiants incomplets dans les variables d'environnement. Saisie interactive nécessaire.")
