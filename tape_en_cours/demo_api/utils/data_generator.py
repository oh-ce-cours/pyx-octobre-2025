...
class VMDataGenerator:
    ...
    def generate_vm_name(cls) -> str:
        ...
        prefixes = ["web", "db", "app", "api", "cache", "monitor", "backup", "test", "dev", "prod"]
...
class UserDataGenerator:
    ...
    COMPANY_DOMAINS = [
        ...
        "company.com", "entreprise.fr", "corp.com", "business.org",
        "tech.io", "startup.com", "innovation.fr", "digital.net"
    ]
    ...
    def generate_user(cls, user_id: int) -> Dict[str, Any]:
        ...
        logger.debug("Utilisateur généré", user_id=user_id, name=name, email=user_data["email"])
        return user_data
...
class DataGenerator:
    ...
    @classmethod
    def generate_users_with_vms(cls, user_count: int = 50, vm_per_user_range: tuple = (0, 5)) -> List[Dict[str, Any]]:
        """
        ...
        """
        logger.info("Génération du dataset", user_count=user_count, vm_range=vm_per_user_range)
    ...
    @classmethod
    def generate_vms_only(cls, vm_count: int, user_ids: List[int]) -> List[Dict[str, Any]]:
        """
        ...
        """
        logger.info("Génération de VMs", vm_count=vm_count, available_users=len(user_ids))
